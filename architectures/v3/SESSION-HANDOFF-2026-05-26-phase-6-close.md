...
- **Phase-7 dispatch prompt authored** at [`next-agent-prompt-phase-7.md`](../../archive/PR-186-next-agent-prompt-phase-7.md). Confirms per-candidate parallel fanout shape (10 subagents, one per spec audited against archive).
