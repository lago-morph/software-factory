  ...
  * Welcomechevron-right
    ...
    * [Overviewchevron-right](/main)
      ...
      * [Protectionchevron-right](/main/welcome/readme/protection)
        ...
        * [Provenance and Attribution](/main/welcome/readme/protection/provenance-and-attribution)
...
block-quoteOn this pageblock-quote
  ...
  3. [Protection](/main/welcome/readme/protection)
...
Attribution and Censorship is _always_ checked as the last step of code generation. Custom behaviors and custom commands cannot be used to override the censorship check.
...
Provenance and Attribution example
...
Tabnine Provenance and Attribution
...
The Provenance and Attribution is currently in private preview and is available to any Tabnine Enterprise customer. Existing Tabnine Enterprise customers should [contact our Support teamenvelope](/cdn-cgi/l/email-protection#f685838686998482b6829794989f9893d895999b) to request access. Once enabled, the Provenance and Attribution capability works on all available models: Anthropic, OpenAI, Cohere, Llama, Mistral, and Tabnine.
...
Censorship exists in [Agent](/main/getting-started/tabnine-agent) as a tool called `check_provenance`. The tool is disabled by default and must be activated in the Admin Console. It is activated by the same toggle that controls Censorship for Chat.
...
**(Available** [**5.26.0**](/main/administering-tabnine/release-notes)**)**
...
[Demo Attribution Logs - attribution-log-234546478.csv](https://3436682446-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FY2qxVf5VTm3fmwP4B4Gx%2Fuploads%2FvqRDqR4DAFn7iG3JzIbH%2FDemo%20Attribution%20Logs%20-%20attribution-log-234546478.csv?alt=media&token=32d73b06-d2ca-4251-b20f-84cf0484c5ac)

downloadDownload[arrow-up-right-from-squareOpen](https://3436682446-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FY2qxVf5VTm3fmwP4B4Gx%2Fuploads%2FvqRDqR4DAFn7iG3JzIbH%2FDemo%20Attribution%20Logs%20-%20attribution-log-234546478.csv?alt=media&token=32d73b06-d2ca-4251-b20f-84cf0484c5ac)
...
We started with the most popular languages ([see above](/main/welcome/readme/protection/provenance-and-attribution#limitations)) expecting to expand our coverage over time. If there is a specific language missing that you would like, let us know and we will consider adding it.
...
The code snippet is sent to the _recitation service_ , which is then installed on premises. From there, we calculate the _signature hashes_ in that snippet, then check a _bloom filter_ to see if those signature hashes are in the _attribution database_. Only the signature hashes that are found in the bloom filter are sent to the attribution service in order to find the references. Note that no plain text code is _ever_ sent to the attribution service, _only_ the signature hashes.

circle-info

We feed the database with open source projects from GitHub _above_ a certain popularity threshold.
