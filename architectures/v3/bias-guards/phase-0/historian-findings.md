...
| **C7** (frozen seed list in [`initial-sources.md`](../../../../initial-sources.md)) | Yes — [`research/PLAN.md`](../../../../research/PLAN.md) §2 explicitly tags it `(frozen)`. | None new. |
