...
- **Contract-check time (usage-vs-promises — README:201).** C45 runs the contract verification
  (Pact/schemathesis/Prism) of the twin against the real service's contract → a **contract-conformance
