...
| **P3c** | P7 digital twins per service (C44/C45) | LocalStack (README:468) | "Repeat per dependency." C43 boundary-typing/blast-radius half → P2 entry precondition per **D-18 (provisional, operator-confirm)**; twin-isolation half stays P3c. |
