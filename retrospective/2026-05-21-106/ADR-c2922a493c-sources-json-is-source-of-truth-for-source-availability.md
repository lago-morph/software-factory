# ADR: Source-availability tracking lives in sources.json, not in plan docs
...
**Harder:**
- Adding a wanted source now requires going through `research-pipeline _catalog/edit.md` patterns rather than just typing a bullet into PLAN.md. Marginal cost: ~30 seconds per addition, vs zero.
...
- [`./SKILL-SPEC-d5f8b37eeb-plan-doc-curation.md`](./SKILL-SPEC-d5f8b37eeb-plan-doc-curation.md) — the plan-doc curation skill that operationalises this decision.
- [`./AGENTS-MD-58b96eb4b3-no-source-tracking-in-plan-docs.md`](./AGENTS-MD-58b96eb4b3-no-source-tracking-in-plan-docs.md) — the corresponding AGENTS.md rule.
- PR the decision was made in: #106.
- Pre-existing related skill: `.claude/skills/research-pipeline/SKILL.md` (catalog edit conventions).
