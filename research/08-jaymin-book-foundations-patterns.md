...
**Diff target:** `architectures/00-comparison.md`.
...
- **Anti-pattern source footnotes [1]–[7]** (Liu, Husain, Willison) in the Twelve Leverage Points file were captured but not chased to their primary sources; those sources overlap heavily with the Round-1 corpus already digested in `research/05-simon-willison.md` and elsewhere.
