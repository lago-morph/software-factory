...
> Track: A (faithful)
> Binding decisions obeyed: **D-14** (G37 secrets ≠ FE-3 signing), **D-25** (secrets deferred — keep config/env now, adopt minimal off-the-shelf env-injection or SOPS at first real credential; the G37 posture).
