...
### [ Quickstart  Download and start building with Codex.  Get started  ](/codex/quickstart)### [ Explore use cases  Get inspiration on what you can build with Codex.  Learn more  ](/codex/use-cases)### [ Community  Read community posts, explore meetups, and connect with Codex builders.  See community  ](/community)### [ Codex for Open Source  Apply or nominate maintainers for API credits, ChatGPT Pro with Codex, and selective Codex Security access.  Learn more  ](/community/codex-for-oss)
