...
- **"Willison: 4 agents → exhausted by 11 AM" is corrected.** The verbatim Lenny editorial says only *"why he's mentally exhausted by 11 a.m."*; the specific "4 parallel agents" number was a v1 fabrication. The cognitive ceiling is real and Simon-reported; the specific number is not.
...
The cognitive ceiling is real. The Lenny editorial confirms Simon is *"mentally exhausted by 11 a.m."* running parallel agents; the specific "4 agents" number was a v1 fabrication and has been removed. Cherny claims 10–30 PRs/day across 10–15 parallel sessions because his role is *scheduling*, not *supervision*. The implication for any factory: the human role has to change shape as parallelism increases — from per-agent supervisor to scheduler, batcher, and high-level reviewer.
...
- **Willison:** mentally exhausted by 11 a.m. running parallel agents (specific count fabricated in v1; only the exhaustion claim is verifiable).
- **Cherny:** 10–15 sessions, but as a *scheduler*, not a supervisor; 10–30 PRs/day.
...
| HN + Lenny | Practitioner anchor data (Cherny 10–30 PRs/day; Willison "mentally exhausted by 11 a.m."); $1k/day and ~$20k/month cost anchors; **noosphr's independent $500–5000/day-per-seat data point**; five sharpest skepticism critiques (Hallucination Loop, reward hacking, spec-completeness, code-quality, normalization of deviance); **Jay Taylor's DTU origin story**; **StrongDM acquired by Delinea**; Dan Shapiro 5-level taxonomy; Three Attractor reimplementations (kilroy, forge, software-factory) |
