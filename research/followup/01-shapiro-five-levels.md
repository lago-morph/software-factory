...
- [`07-dark-factory`](../07-dark-factory.md) — should note El Kaim *paraphrases* Shapiro rather than reproducing him. Particularly the L4 "spec is the most valuable thing you produce" and L5 "nobody writes / nobody reads" framings are El Kaim's compressions, not Shapiro verbatim.
