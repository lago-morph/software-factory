...
## 6c. See also — Cluster-J dedicated reports

Two Cluster-J Kahana pieces were judged of sufficient scope and corpus-load-bearing centrality to warrant dedicated reports rather than supplements to this followup:
...
The relationship to this followup: §A/§B/§C anchor the AILCCP vocabulary that both dedicated reports invoke. The dedicated reports apply the vocabulary to harness-engineering (report 30) and board-level fiduciary duty (report 31). The three live in close conversation; reading any one of the three alone leaves Kahana's framework incomplete.
