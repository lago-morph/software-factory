...
4. ~~**Edit `spec-driven-ai-dev.md`** to add the four spec-template fields proposed by report 14 (non-goals, decision-seeds, invariant-with-bindingHint, the explicit Intent section).~~ **Retired 2026-05-21** (issue [#105](https://github.com/lago-morph/software-factory/issues/105)): `spec-driven-ai-dev.md` is a cataloged source (record `3592091691`), not a mutable internal artifact. Report 14's 4-field proposal stands as a research finding.
