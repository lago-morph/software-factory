...
| T6 | **Rule-conversion handoff.** For an approved pattern, emit a new rule to the correct sink — C10 (spec-structural), C15 (workflow-structural), or a C30 Inspect-AI rubric (satisfaction-class). Keep a provenance back-reference (cluster → rule). | M | T5, C10, C15, C30 |
