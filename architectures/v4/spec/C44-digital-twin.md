...
> residual for the integrator. *(C45 is the same batch but not on disk yet; this binds the seam from C44's side.)*
...
> residual. *(C43 is the same batch but not on disk yet; this binds the seam from C44's side.)*
