...
\newcommand{\rewriter}{Privileged LLM\xspace}
\newcommand{\isolated}{Quarantined LLM\xspace}
\newcommand{\pllm}{P-LLM\xspace}
\newcommand{\qllm}{Q-LLM\xspace}
\newcommand{\infosharing}{Privacy Assistant\xspace}

\newcommand{\pythoninline}{\mintinline{python}}
\newcommand{\code}[1]{{\footnotesize\color{gray} \texttt{#1}}}
...
\newtcbtheorem[number within=section]{highlightedobservation}{Observation}{
    enhanced,
    breakable,
    colback=gray!20,
    colframe=black,
...
\newcommand{\userbox}[1]{
    \colorbox{cyan!20}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}#1\end{minipage}}
}

\newcommand{\assistantbox}[1]{
    \colorbox{green!20}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}#1\end{minipage}}
}

\newcommand{\toolbox}[1]{
    \colorbox{magenta!20}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}#1\end{minipage}}
}

\newcommand{\systembox}[1]{
    \colorbox{yellow!20}{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}#1\end{minipage}}
}
...
\newcommand{\actions}{\Omega_\prompt}
\newcommand{\Trace}{\mathsf{Trace}}
\newcommand{\tools}{\mathsf{tools}}
\newcommand{\tool}{\mathsf{tool}}
\newcommand{\args}{\mathsf{args}}
\newcommand{\policies}{\mathsf{policies}}
