...
| 05 | simon-willison | ✅ | Simon Willison's `agentic-engineering-patterns` 12-chapter guide + software-factory post. |
| 06 | hn-and-lenny | ✅ | HN thread on dark factories + Lenny Cherny/Willison interview references. Cherny "10–30 PRs/day" remains un-primary-sourced (video-only). |
