# ADR 0005: The concrete-task criterion applies to every entry in a plan doc
...
[`research/PLAN.md`](../../research/PLAN.md)'s `## Future research` section had four entries:
...
The user articulated the general rule when reviewing cleanup-plan v2: "there is only work if you can tell me exactly what to do. Otherwise it isn't a task. Use this criteria for all steps."

## Decision

Every entry in a plan doc must be a concrete, executable instruction; entries that cannot be reduced to exactly-what-to-do are either moved to a status tracker ([`reference-only/sources.json`](../../reference-only/sources.json) wanted record for source items) or deleted from the plan.
...
- [`retrospective/2026-05-21-106.md`](../../retrospective/2026-05-21-106.md) — the source retrospective; full draft at [`retrospective/2026-05-21-106/ADR-224e9669ef-concrete-task-criterion.md`](../../retrospective/2026-05-21-106/ADR-224e9669ef-concrete-task-criterion.md).
- [`retrospective/2026-05-21-106/SKILL-SPEC-d5f8b37eeb-plan-doc-curation.md`](../../retrospective/2026-05-21-106/SKILL-SPEC-d5f8b37eeb-plan-doc-curation.md) — the plan-doc-curation skill that operationalises this criterion in Step 3.
