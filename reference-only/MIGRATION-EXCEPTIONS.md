...
Records that were initially auto-created from URL citations in research/ reports but are not substantive enough to track in the source catalog. Listed here for traceability.

If you want any of these in the catalog after all, add them via `process-url-list.py` or `edit.md`.

## casual host: api.github.com (1 record(s))

- `ba00ff30b3` — [(unknown)](https://api.github.com/) — cited in research/followup/02-attractor-implementations.md

## casual host: apps.apple.com (1 record(s))

- `22eac821ab` — [(unknown)](https://apps.apple.com/us/app/claude-by-anthropic/id6473753684) — cited in research/06-hn-and-lenny.md

## casual host: www.linkedin.com (3 record(s))

- `a727499e6f` — [(unknown)](https://www.linkedin.com/in/bcherny) — cited in research/06-hn-and-lenny.md
- `d5d09702d4` — [(unknown)](https://www.linkedin.com/in/bkurkela) — cited in research/06-hn-and-lenny.md
- `7d817016ce` — [(unknown)](https://www.linkedin.com/in/fionafung) — cited in research/06-hn-and-lenny.md

## casual host: x.com (7 record(s))

- `b418963be8` — [(unknown)](https://x.com/DarioAmodei) — cited in research/06-hn-and-lenny.md
- `caab309fe1` — [(unknown)](https://x.com/bcherny) — cited in research/06-hn-and-lenny.md
- `679f309525` — [(unknown)](https://x.com/ch402) — cited in research/06-hn-and-lenny.md
- `fb386dae58` — [(unknown)](https://x.com/jenny_wen) — cited in research/06-hn-and-lenny.md
- `4c55031501` — [(unknown)](https://x.com/karpathy/status/1886192184808149383) — cited in research/06-hn-and-lenny.md
- `d023ff4cf9` — [(unknown)](https://x.com/lennysan/status/2020266745722991051) — cited in research/06-hn-and-lenny.md
- `2209523ec8` — [(unknown)](https://x.com/simonw/status/2007904766756880848) — cited in research/06-hn-and-lenny.md

## casual host: youtu.be (2 record(s))
...
- `92adbdecc9` — [(unknown)](https://2389.ai/) — cited in research/07-dark-factory.md
- `ce648aa931` — [(unknown)](https://borischerny.com/) — cited in research/06-hn-and-lenny.md
- `550631f98b` — [(unknown)](https://code.claude.com/) — cited in research/06-hn-and-lenny.md
- `bbba856f6f` — [(unknown)](https://cursor.com/) — cited in research/06-hn-and-lenny.md
- `90f2203368` — [(unknown)](https://docs.fabro.sh/) — cited in research/followup/02-attractor-implementations.md
- `0d927f6b6f` — [(unknown)](https://docs.gastownhall.ai/) — cited in research/07-dark-factory.md
- `0f1199c79d` — [(unknown)](https://freshell.net/) — cited in research/07-dark-factory.md
- `11d9dc68e1` — [(unknown)](https://gastownhall.ai/) — cited in research/07-dark-factory.md
- `23bc1dde43` — [(unknown)](https://nanoclaw.dev/) — cited in research/06-hn-and-lenny.md
- `0f63a2a5a5` — [(unknown)](https://news.ycombinator.com/) — cited in research/06-hn-and-lenny.md
- `1f786a729d` — [(unknown)](https://nodejs.org/) — cited in research/06-hn-and-lenny.md
- `a80910fb45` — [(unknown)](https://openclaw.ai/) — cited in research/06-hn-and-lenny.md
- `1d1b4e8372` — [(unknown)](https://redis.io/) — cited in research/06-hn-and-lenny.md
- `f715fbeb33` — [(unknown)](https://windsurf.com/) — cited in research/06-hn-and-lenny.md
- `e302056254` — [(unknown)](https://wisprflow.ai/) — cited in research/06-hn-and-lenny.md
- `01d68d957a` — [(unknown)](https://www.acquired.fm/) — cited in research/06-hn-and-lenny.md
- `afe2508ac4` — [(unknown)](https://www.anthropic.com/) — cited in research/06-hn-and-lenny.md
- `a6ad87b96b` — [(unknown)](https://www.cloudflare.com/) — cited in research/06-hn-and-lenny.md
- `a16df53fdc` — [(unknown)](https://www.firefox.com/) — cited in research/06-hn-and-lenny.md
- `d83d5c546d` — [(unknown)](https://www.shopify.com/) — cited in research/06-hn-and-lenny.md
- `e96888de09` — [(unknown)](https://www.strongdm.com/) — cited in research/07-dark-factory.md
- `df0dfac8f9` — [(unknown)](https://www.thoughtworks.com/) — cited in research/06-hn-and-lenny.md

## title-only (no canonical URL) (1 record(s))

- `f3b49991be` — Software factory deep research report (artifact)

---

# Auto-extracted URLs not promoted to catalog

During the PR #80 migration, 167 additional URLs were extracted from research/ reports that aren't substantive enough to track as catalog records. They're listed here so `check-source-refs.py` knows we've decided NOT to track them (lint won't complain).

If any of these should actually be in the catalog, move them via `python scripts/process-url-list.py`. Don't edit this file by hand to add records — add to the catalog instead.
